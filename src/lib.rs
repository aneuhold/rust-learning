...
impl ActionKV {
    /// Opens a file for reading and writing and initializes the index
    ...
    /// Loads the data from the file into the index
    ...
    /// Not sure what this one does exactly yet? Looks like it reads a
